...
public class QueryUtilsTest {
    ...
    public void bookQueryFilter() {
        ...
        Assert.assertTrue("(fmt:BK AND (date1_int:[1911 TO 2012]))".equals(catalogBKFilterQueryPart));
        ...
        Assert.assertTrue("(fmt:SE AND (date1_int:[1911 TO 2013]))".equals(catalogSEFilterQueryPart));
    }
